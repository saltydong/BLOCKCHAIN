...
{	
    ...
    {		
        ...
        server.createContext("/api/login", new requestHandler("login"));
        server.createContext("/api/regist", new requestHandler("regist"));
        ...
        server.createContext("/api/company/send", new requestHandler("company/send"));
